...
- [Tech Notes](docs/tech-notes.md) — daily sync log: integrations, shipped items, open threads.
- [Integration API Spec](docs/integrations-spec.md) — partner brief for the Otto integration cards.
